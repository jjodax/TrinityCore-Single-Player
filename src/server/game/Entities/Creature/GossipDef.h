...
class TC_GAME_API GossipMenu
{
    public:
        ...
        void AddMenuItem(int32 menuItemId, uint8 icon, std::wstring const& message, uint32 sender, uint32 action, std::string const& boxMessage, uint32 boxMoney, bool coded = false);
